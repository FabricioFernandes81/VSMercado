        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cidades_estados_EstadosId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_empresas_cidades_CidadesId",
                        column: x => x.CidadesId,
                        principalTable: "cidades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_empresas_estados_EstadosId",
                        column: x => x.EstadosId,
                        principalTable: "estados",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "estados",
                columns: new[] { "Id", "nome", "uf" },
                values: new object[] { 3, "Amazonas", "AM" });

            migrationBuilder.InsertData(
                table: "cidades",
                columns: new[] { "Id", "EstadosId", "nome" },
                values: new object[,]
                {
                    { 1, 2, "Belém" },
                    { 2, 2, "Batalha" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cidades_EstadosId",
                table: "cidades",
                column: "EstadosId");

            migrationBuilder.CreateIndex(
                name: "IX_empresas_CidadesId",
                table: "empresas",
                column: "CidadesId");

            migrationBuilder.CreateIndex(
                name: "IX_empresas_EstadosId",
                table: "empresas",
                column: "EstadosId");
        }
